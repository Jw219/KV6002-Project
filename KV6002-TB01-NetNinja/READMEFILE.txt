...
Run the requirements.txt files for the python scripts and the package.json files to complete the install of all necessary libraries and dependencies.
